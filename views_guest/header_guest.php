	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="border-bottom: #a8a8a8 4px solid">
		...
		<div class="collapse navbar-collapse" id="navbar">
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				<li class="nav-item">
					<a class="nav-link" href="index_guest.php">Home</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="supplier_guest.php">Daftar Supplier</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="barang_guest.php">Daftar Barang</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="mutasi_guest.php">Mutasi Barang</a>
				</li>
